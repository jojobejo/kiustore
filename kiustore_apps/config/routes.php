...
$route['api/v1/coupons/check']              = 'api/mobile/coupon_check';
...
$route['api/v1/orders/(:num)/coupon']       = 'api/mobile/apply_order_coupon/$1';
$route['api/v1/orders/(:num)/payment-method'] = 'api/mobile/select_payment_method/$1';
$route['api/v1/orders/(:num)/payments/briva'] = 'api/mobile/generate_briva_payment/$1';
$route['api/v1/orders/(:num)/payments/briva/status'] = 'api/mobile/briva_payment_status/$1';
$route['api/v1/orders/(:num)/payments/bank-transfer'] = 'api/mobile/confirm_bank_transfer/$1';
$route['api/v1/orders/(:num)/complete']     = 'api/mobile/complete_order/$1';
...
$route['admin/zahir-stock-alias']           = 'admin/zahir_stock_alias';
$route['admin/zahir-stock-alias/store']     = 'admin/zahir_stock_alias/store';
$route['admin/zahir-stock-alias/update/(:num)'] = 'admin/zahir_stock_alias/update/$1';
$route['admin/zahir-stock-alias/delete/(:num)'] = 'admin/zahir_stock_alias/delete/$1';
