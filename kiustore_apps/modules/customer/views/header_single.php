...
<html lang="en">
  ...
  <head>
    ...
    <!-- Style css -->
    <link rel="stylesheet" id="change-link" type="text/css" href="<?php echo get_theme_uri('css/style.css');?>" />
    <link rel="stylesheet" type="text/css" href="<?php echo get_theme_uri('css/message.css');?>" />
  </head>
  <!-- Head End -->
