...
class Profile_model extends CI_Model
{
    ...
    public function get_profile()
    {
        ...
        $data = $this->db->query("
            SELECT u.id, c.alamat_kirim, u.email,c.province_id, c.kota_id, c.name, c.phone_number, c.address, c.shop_name, c.shop_address, c.max_credit, c.profile_picture, u.password , u.email
            FROM users u
            JOIN customers c
                ON c.user_id = u.id
            WHERE u.id = '$id'
