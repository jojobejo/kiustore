                    ...
                    <div class="card user-data-card">
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="address" class="form-control" id="address" required><?php echo $customer->shop_address; ?></textarea>
                            </div>
                            <div class="mb-3">
                            ...
                            <?php foreach ($is_ongkir as $isongkir) : ?>
                                <?php if ($isongkir->ongkir == 0) : ?>
                                    <div class="shipping-method-choose mb-3">
                                        <div class="alert alert-info">Metode Pembayaran</div>
                                            ...
                                            <div class="card-body">
                                                <div class="payment-method-choose">
                                                    <div class="row">
                                                        ...
                                                        <div class="input-box col-6">
                                                            <input type="radio" name="payment" id="tfbank" value="3" />
                                    ...
                                    <div class="shipping-method-choose mb-3">
                                        ...
                                        <div class="row">
                                            <div class="col-3">
                                                <a href="https://www.jtcargo.id/networkQuery?type=2&senderAddressVal=&receiveAddressVal=&sender=%7B%22areaId%22%3A%22%22,%22cityId%22%3A%22%22,%22provinceId%22%3A%22%22%7D&receive=%7B%22areaId%22%3A%22%22,%22cityId%22%3A%22%22,%22provinceId%22%3A%22%22%7D&weight" class="btn btn-primary btn-sm w-100" target="_blank">J&T Cargo</a>
                                            </div>
                                            <div class="col-3">
                                                <a href="https://indahonline.com/shipping/rates" class="btn btn-primary btn-sm w-100" target="_blank">Indah Cargo</a>
                                            </div>
                                            <div class="col-3">
                                                <a href="https://sentralcargo.co.id/ongkir" class="btn btn-primary btn-sm w-100" target="_blank">Sentral Cargo</a>
                                            </div>
                                            <div class="col-3">
                                                <a href="https://barakaexpress.co.id/cek-tarif/" class="btn btn-primary btn-sm w-100" target="_blank">Baraka Express</a>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="input-box col-6">
                                                        ...
                                                        <input id="karisma" name="shipping" type="radio" value="9" checked>
                                                        PT. Karisma Indoagro Universal
                                                        <label for="karisma"></label>
                                                        <div class="check"></div>
                                                    </div>
                                                </div>
                                            </div>
