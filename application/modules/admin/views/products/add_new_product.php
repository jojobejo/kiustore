        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-3">
                <div class="form-group">
                  <label class="form-control-label" for="stock">Satuan Kecil:</label>
                  <select name="product_unit_1" class="form-control" id="product_unit_1" value="<?php echo set_value('product_unit_1'); ?>">
              ...
              <div class="col-6">
                <div class="form-group">
                  ...
                  <input type="text" name="product_unit_value" value="<?php echo set_value('product_unit_value'); ?>" class="form-control" id="product_unit_value">
            ...
            <div class="row">
              <div class="col-3">
                <div class="form-group">
                  ...
                  <select name="product_unit_2" class="form-control" id="product_unit_2" value="<?php echo set_value('product_unit_2'); ?>">
                    <option>Pilih Satuan Product</option>
                    <option value="Box">Box</option>
                    <option value="Sak">Sak/karung</option>
                  </select>
                  <?php echo form_error('product_unit_2'); ?>
                </div>
              </div>
              <div class="col-6">
                <div class="form-group">
                  <label class="form-control-label" for="stock">Stok (dalam satuan kecil):</label>
